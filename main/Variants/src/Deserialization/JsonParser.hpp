...
class JsonParser {
 ...
 private:
  ...
  bool parseAnythingTo(MultiType *destination);

  inline bool parseArrayTo(MultiType *destination);
  inline bool parseObjectTo(MultiType *destination);
  inline bool parseStringTo(MultiType *destination);
