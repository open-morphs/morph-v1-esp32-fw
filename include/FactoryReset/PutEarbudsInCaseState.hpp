...
struct PutEarbudsInCaseState : FactoryResetState {
    ...
    uint8_t process() override {
        ...
        const std::string descrMessage = stringUtils::format(
                LANGUAGE_PACK[Languages::eTitleType::TITLE_RESET_PUT_EARBUDS],
                ePrimaryEarbud::EARBUD_LEFT == primaryDevice ? LANGUAGE_PACK[Languages::eTitleType::TITLE_RIGHT]
                                                             : LANGUAGE_PACK[Languages::eTitleType::TITLE_LEFT],
                ePrimaryEarbud::EARBUD_LEFT == primaryDevice ? LANGUAGE_PACK[Languages::eTitleType::TITLE_LEFT]
                                                             : LANGUAGE_PACK[Languages::eTitleType::TITLE_RIGHT]);

        GRAPHICS.setResetScreen(_incomingSignal == FSM_SIGNAL_FIRST_PAIRING_DONE ? "4/8" : "7/8", descrMessage, true,
                                false, true);
