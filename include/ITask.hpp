...
public:
    ...
    explicit ITask(const std::string &taskName = "Task", const uint16_t stackSize = configMINIMAL_STACK_SIZE,
                   const uint8_t priority = defaultPriority, const BaseType_t coreID = 0);
