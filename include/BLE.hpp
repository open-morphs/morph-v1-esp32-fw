...
public:
    ...
    bool sendCommand(const eVendorType vendor, const uint8_t cmd, const uint8_t feature, const uint8_t *data = nullptr,
...
private:
    ...
    bool sendPacket(ESP32Kolban::BLERemoteCharacteristic *characteristic, const PduPacket &packet,
                    const uint8_t *data = nullptr, const size_t dataLen = 0);
